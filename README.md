...
- **Hybrid search** - combine dense embeddings with BM25 keyword search for exact clause number lookups (e.g. "52.204-21")
- **Reranking** - add a cross-encoder reranker after MMR retrieval for higher precision
